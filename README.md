# Tucunaré
A simple 3D graphics rendering pipeline for the HTML5 Canvas. Created to pay homage to my college computer graphics professor, who passed away shortly after I took his class and who taught me most of the concepts used here.
...
## Issues/Improvements
These are some issues/improvements I hope to address as time permits.
* ISSUE: Memory issues on Chrome in Windows
* IMPROVEMENT: Drawing with indexed arrays similar to the OpenGL function glDrawElements
* IMPROVEMENT: Webworkers to parallelize the workload
